...
int Serial::Open(const char* name)
{
	Close();
#if defined(LINUX)
...
const char* Serial::get_name(void)
{
...
char* Serial::error_message(void)
{
	return error_msg;
}
...
/*int Serial::Set_baud(const char* baud_str)
{
	unsigned long b;
